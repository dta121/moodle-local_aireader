...
$string['report_cost_note'] = 'Costs are estimates for budgeting only, derived from the narration character count and the model used. Translation and Whisper alignment are billed separately and are not included.';
