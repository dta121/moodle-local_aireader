...
$string['setting_defaultlanguage'] = 'Default narration language';
$string['setting_defaultlanguage_auto'] = 'Automatic (site language, then the first language offered)';
$string['setting_defaultlanguage_desc'] = 'The language the player starts in. Learners whose Moodle interface language is one of the offered languages still get that; this decides the starting language for everyone else, and is listed first in the picker. Leave on Automatic to use the site language ({$a}) when it is offered, otherwise the first offered language, which is alphabetical by name, so an English site that also offers Afrikaans and Arabic would start in Afrikaans. A choice that is not ticked above is ignored.';
...
$string['status_cooling_down'] = 'This narration has failed repeatedly, so automatic retries are paused for a while. Press Regenerate to try again now.';
...
$string['task_reap_dead_tasks'] = 'Remove AI narration tasks that are out of retry attempts';
